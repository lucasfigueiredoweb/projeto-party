 ...
 repeat
  ...
  seek(banco_dados,codigo);
   ...
   readln(banco_dados,pessoa);
    ...
    writeln('Endereço:',pessoa.endereco);
    writeln;
...
Begin
	 ...
	 begin
	 registro;
	 Writeln('Deseja adicionar mais alguma pessoa?  OBS: Será cobrado R$24.80 por pessoa!.[S/N]');
	 read(add_pizzaria);
...
Begin 
	 ...
	 begin
	 Writeln('Quantas pessoas ira adicionar?   OBS: Será cobrado R$32,00 por pessoa!. ');
	 read(churrascop);
	 clrscr;
